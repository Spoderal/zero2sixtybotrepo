      ...
      .then(async (msg) => {
       ...
       Page 1\n
            ${parts.Parts["t1exhaust"].Emote}  ${
                  ...
                  } : $${numberWithCommas(parts.Parts["t1exhaust"].Price)}\n
            ${parts.Parts["t2exhaust"].Emote}  ${
                    parts.Parts["t2exhaust"].Name
                  } : $${numberWithCommas(parts.Parts["t2exhaust"].Price)}\n
            ${parts.Parts["t3exhaust"].Emote}  ${
                    parts.Parts["t3exhaust"].Name
                  } : $${numberWithCommas(parts.Parts["t3exhaust"].Price)}\n
    ...
    **`
            ...
            Page 1\n
                 ${parts.Parts["t1intake"].Emote}  ${
                  ...
                  } : $${numberWithCommas(parts.Parts["t1intake"].Price)}\n
                 ${parts.Parts["t2intake"].Emote}  ${
                    parts.Parts["t2intake"].Name
                  } : $${numberWithCommas(parts.Parts["t2intake"].Price)}\n
                 ${parts.Parts["t3intake"].Emote}  ${
                    parts.Parts["t3intake"].Name
                  } : $${numberWithCommas(parts.Parts["t3intake"].Price)}\n
            ...
            **`
            ...
            Page 1\n
                 ${parts.Parts["turbo"].Emote}  ${
                  ...
                  } : $${numberWithCommas(parts.Parts["turbo"].Price)}\n
                 ${parts.Parts["dualturbo"].Emote}  ${
                    parts.Parts["dualturbo"].Name
                  } : $${numberWithCommas(parts.Parts["dualturbo"].Price)}\n
                 ${parts.Parts["supercharger"].Emote}  ${
                    parts.Parts["supercharger"].Name
                  } : $${numberWithCommas(parts.Parts["supercharger"].Price)}\n
    ...
    Page 1\n
     ${parts.Parts["2jz-gte"].Emote}  ${
                  ...
                  } : $${numberWithCommas(parts.Parts["2jz-gte"].Price)}\n
     ${parts.Parts["v10"].Emote}  ${
                    parts.Parts["v10"].Name
                  } : $${numberWithCommas(parts.Parts["v10"].Price)}\n
     ${parts.Parts["v12"].Emote}  ${
                    parts.Parts["v12"].Name
                  } : $${numberWithCommas(parts.Parts["v12"].Price)}\n
     ${parts.Parts["ls1"].Emote}  ${
                    parts.Parts["ls1"].Name
                  } : $${numberWithCommas(parts.Parts["ls1"].Price)}\n
     ${parts.Parts["ls2"].Emote}  ${
                    parts.Parts["ls2"].Name
                  } : $${numberWithCommas(parts.Parts["ls2"].Price)}\n
     ${parts.Parts["ls3"].Emote}  ${
                    parts.Parts["ls3"].Name
                  } : $${numberWithCommas(parts.Parts["ls3"].Price)}\n
     ${parts.Parts["rocket engine"].Emote}  ${
                    parts.Parts["rocket engine"].Name
                  } : $${numberWithCommas(parts.Parts["rocket engine"].Price)}\n
    ...
    **`
            ...
            Page 1\n
             ${parts.Parts["t1gearbox"].Emote}  ${
                  ...
                  } : $${numberWithCommas(parts.Parts["t1gearbox"].Price)}\n
             ${parts.Parts["t2gearbox"].Emote}  ${
                    parts.Parts["t2gearbox"].Name
                  } : $${numberWithCommas(parts.Parts["t2gearbox"].Price)}\n
             ${parts.Parts["t3gearbox"].Emote}  ${
                    parts.Parts["t3gearbox"].Name
                  } : $${numberWithCommas(parts.Parts["t3gearbox"].Price)}\n
