...
module.exports = {
  ...
  async execute(interaction) {
   ...
   await interaction.reply("Please wait...")
    ...
    .setTitle("List of cars in the game")
    if(subcommand == "all"){
        embed 
    .setTitle("List of cars in the game")
        for(let car in cardb){
                ...
                carslist.push({Name: cardb[car].Name, Emote: cardb[car].Emote, Brand: brand[0], Price: price})
        ...
        if(!branddb[brandtofilter.toLowerCase()]) return interaction.reply("Thats not a brand!")
        
        
        embed.setTitle(`List of ${branddb[brandtofilter.toLowerCase()].name} cars in the game`)
        for(let car in cardb){
            ...
            console.log(brand)
            if(brand[0] && brand[0].name.toLowerCase() == brandtofilter.toLowerCase()){
                carslist.push({Name: cardb[car].Name, Emote: cardb[car].Emote, Brand: brand[0], Price: price})
