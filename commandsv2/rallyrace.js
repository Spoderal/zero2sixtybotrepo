...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    async execute(interaction) {
        ...
        let offroad = db.fetch(`${cars.Cars[selected.toLowerCase()].Name}offroad_${interaction.user.id}`);
        ...
        let hp2 = cars.Cars[botcar.toLowerCase()].Speed / otherzero2sixty + othernewhandling + cars.Cars[botcar.toLowerCase()].Rally
        ...
        setTimeout(() => {
            interaction.channel.send("⛔ Jump! ⛔").then(async emb => {
              ...
              let gifs = ["https://c.tenor.com/0u3SUF5GcWUAAAAS/subaru-rally-wrc-subaru.gif", "https://media1.giphy.com/media/oKuiwS2NsAhjy/giphy.gif", "https://media1.giphy.com/media/xT0BKi8beZIotuqrFS/200.gif"]
              collector.on('collect', async (r, user) => {
                  if (r.emoji.name === '❌') {
                    embed.setImage("https://media2.giphy.com/media/3xINyooRG4JB4XPKQu/200w.gif?cid=82a1493by2jz4yaxvxevizi1x2k7e4mk5yl7ija1igl2l5u9&rid=200w.gif&ct=g")
