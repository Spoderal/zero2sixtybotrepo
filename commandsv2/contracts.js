...
module.exports = {
  ...
  async execute(interaction) {
    ...
    .setTitle("Contracts")
    .setColor("#60b0f4")
    .setDescription("Contracts are available tasks you can complete for rewards, they are repeatable, and can be completed at any time depending on your prestige rank.")
