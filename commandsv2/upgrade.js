...
module.exports = {
  ...
  console.log(actpart)
  let realpart = parte
  if(!userdata.parts.includes(realpart.toLowerCase())) return interaction.reply(`You don't have this part!`)
  if(selected[actpart] && selected[actpart] !== null) return interaction.reply(`This car already has a "${actpart}"!`)
