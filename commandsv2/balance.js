...
module.exports = {
  ...
  async execute(interaction) {
    ...
    let embed = new Discord.MessageEmbed()
      ...
      .setDescription(
        `${emote} Z Cash: $${numberWithCommas(cash)}\n
      ...
      .addField(
        ...
        `
          ...
          <:zbarns_u:958540705964371978> Uncommon: ${numberWithCommas(
            ubarnmaps
          )}
          <:zbarns_r:958539547828965406> Rare: ${numberWithCommas(rbarnmaps)}
          <:zbarns_l:958539547736674314> Legendary: ${numberWithCommas(
            lbarnmaps
          )}`,
        true
      )
      ...
      .addField(
        "Event Items",
        `
          <:zeronotor:962785804202176574> Notoriety: ${numberWithCommas(
            notoriety
          )}
         `,
        true
