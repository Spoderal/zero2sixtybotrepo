...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if(!selected[0]) return interaction.reply("Thats not a car! Make sure to specify the car by **ID**, not name")
    let stars = []
    ...
    let carimg = selected[0].Image || cardb.Cars[selected[0].Name.toLowerCase()].Image
    ...
    .setFooter({text:`Boost your rating by installing body kits, liveries, and washing it!`})
