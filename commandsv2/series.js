const {
  ...
  module.exports = {
    ...
    async execute(interaction) {
      ...
      let seriescomplfilt = userdata.cars.filter((car) => car.Name == "1980 Porsche 911")

      if(seriescomplfilt[0] && seriescomplfilt[0].Wins >= 50 && userdata.perfectengineeringcomplete !== true){
        row3.addComponents(
          new ButtonBuilder()
      ...
      const filter = (interaction2) =>
        ...
        const filter2 = (interaction2) => interaction2.user.id === interaction.user.id;
      ...
      collector2.on("collect", async (i) => {
       ...
       else if(i.customId == "claimcarfinal" && userdata.perfectengineeringcomplete !== true){
