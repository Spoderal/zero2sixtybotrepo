...
module.exports = {
    ...
    async execute(interaction) {
     ...
     if(!created) return interaction.reply(`Use \`/start\` to begin!`)
      ...
      if(newplayer && newplayerstage == 1){
        ...
        <:zero2sixty:966453514425495602> Recently released cars`, true)
        .setColor('#60b0f4')
        .setDescription(`\`/buy (full car name)\` to buy a car\n\n[Official Server](https://discord.gg/bHwqpxJnJk)\n[Buy me a coffee!](https://www.buymeacoffee.com/zero2sixty)`)
        interaction.reply({embeds: [embed], components: [row], fetchReply: true}).then(async msg => {
         ...
         ${cars.Cars["2002 ford mustang"].Emote} ${cars.Cars["2002 ford mustang"].Name} : $${numberWithCommas(cars.Cars["2002 ford mustang"].Price)}\n
         ${cars.Cars["2012 hyundai veloster"].Emote} ${cars.Cars["2012 hyundai veloster"].Name} : $${numberWithCommas(cars.Cars["2012 hyundai veloster"].Price)}\n
         ${cars.Cars["1986 toyota ae86"].Emote} ${cars.Cars["1986 toyota ae86"].Name} : $${numberWithCommas(cars.Cars["1986 toyota ae86"].Price)}\n
         ${cars.Cars["2007 infiniti g35 coupe"].Emote} ${cars.Cars["2007 infiniti g35 coupe"].Name} : $${numberWithCommas(cars.Cars["2007 infiniti g35 coupe"].Price)}\n
        ...
        **`)
        .setColor('#60b0f4')
         ...
         ${cars.Cars["2022 toyota gr86"].Emote} ${cars.Cars["2022 toyota gr86"].Name} : $${numberWithCommas(cars.Cars["2022 toyota gr86"].Price)}
         **`)
         .setColor('#60b0f4')
         .setThumbnail("https://i.ibb.co/NZ8ySF8/Dclass.png")
         interaction.editReply({embeds: [embed2], components: [row]})
   ...
   .setDescription(`**
   Page 1\n
   ${cars.Cars["1992 toyota supra mk3"].Emote} ${cars.Cars["1992 toyota supra mk3"].Name} : $${numberWithCommas(cars.Cars["1992 toyota supra mk3"].Price)}\n
   ...
   **`)
   ...
   ${cars.Cars["1990 bmw 850i"].Emote} ${cars.Cars["1990 bmw 850i"].Name} : $${numberWithCommas(cars.Cars["1990 bmw 850i"].Price)}\n
   ${cars.Cars["2018 kia stinger"].Emote} ${cars.Cars["2018 kia stinger"].Name} : $${numberWithCommas(cars.Cars["2018 kia stinger"].Price)}\n
   ${cars.Cars["2015 hsv gts maloo"].Emote} ${cars.Cars["2015 hsv gts maloo"].Name} : $${numberWithCommas(cars.Cars["2015 hsv gts maloo"].Price)}
   **`)
.setColor("#60b0f4")   .setThumbnail("https://i.ibb.co/XxvHmCc/cclass.png")
   interaction.editReply({embeds: [embed2], components: [row]})
  ...
  ${cars.Cars["2021 lexus rc f"].Emote} ${cars.Cars["2021 lexus rc f"].Name} : $${numberWithCommas(cars.Cars["2021 lexus rc f"].Price)}\n
  ...
  **${cars.Cars["2023 nissan z"].Emote} ${cars.Cars["2023 nissan z"].Name} : $${numberWithCommas(cars.Cars["2023 nissan z"].Price)}\n
  ${cars.Cars["2012 lotus evora s"].Emote} ${cars.Cars["2012 lotus evora s"].Name} : $${numberWithCommas(cars.Cars["2012 lotus evora s"].Price)}\n
   ...
   **${cars.Cars["2019 chevy corvette c7"].Emote} ${cars.Cars["2019 chevy corvette c7"].Name} : $${numberWithCommas(cars.Cars["2019 chevy corvette c7"].Price)}\n** *TRIMS AVAILABLE*
   ...
   **${cars.Cars["2020 chevy corvette c8"].Emote} ${cars.Cars["2020 chevy corvette c8"].Name} : $${numberWithCommas(cars.Cars["2020 chevy corvette c8"].Price)}\n
   ...
   `)
.setColor("#60b0f4")   .setThumbnail("https://i.ibb.co/5KHHqVW/Bclass.png")
   interaction.editReply({embeds: [embed2], components: [row]})
   ...
   .setDescription(`**
   Page 1
   ${cars.Cars["2016 bmw i8"].Emote} ${cars.Cars["2016 bmw i8"].Name} : $${numberWithCommas(cars.Cars["2016 bmw i8"].Price)}\n
   ${cars.Cars["1998 ferrari f355"].Emote} ${cars.Cars["1998 ferrari f355"].Name} : $${numberWithCommas(cars.Cars["1998 ferrari f355"].Price)}\n
   ${cars.Cars["2022 maserati mc20"].Emote} ${cars.Cars["2022 maserati mc20"].Name} : $${numberWithCommas(cars.Cars["2022 maserati mc20"].Price)}\n
   ...
   ${cars.Cars["2013 lexus lfa"].Emote} ${cars.Cars["2013 lexus lfa"].Name} : $${numberWithCommas(cars.Cars["2013 lexus lfa"].Price)}\n
   ...
   ${cars.Cars["2021 mclaren gt"].Emote} ${cars.Cars["2021 mclaren gt"].Name} : $${numberWithCommas(cars.Cars["2021 mclaren gt"].Price)}\n
   ${cars.Cars["2020 mclaren 570s"].Emote} ${cars.Cars["2020 mclaren 570s"].Name} : $${numberWithCommas(cars.Cars["2020 mclaren 570s"].Price)}\n
   ${cars.Cars["2016 bentley continental gt speed"].Emote} ${cars.Cars["2016 bentley continental gt speed"].Name} : $${numberWithCommas(cars.Cars["2016 bentley continental gt speed"].Price)}\n
   ${cars.Cars["2020 aston martin vantage"].Emote} ${cars.Cars["2020 aston martin vantage"].Name} : $${numberWithCommas(cars.Cars["2020 aston martin vantage"].Price)}\n
   
   **`)
.setColor("#60b0f4")   .setThumbnail("https://i.ibb.co/T0Cd62J/aclass.png")
   interaction.editReply({embeds: [embed2], components: [row]})
             ...
             .setDescription(`**
             Page 2\n
             ${cars.Cars["2011 aston martin one-77"].Emote} ${cars.Cars["2011 aston martin one-77"].Name} : $${numberWithCommas(cars.Cars["2011 aston martin one-77"].Price)}\n
             ${cars.Cars["2018 ferrari california"].Emote} ${cars.Cars["2018 ferrari california"].Name} : $${numberWithCommas(cars.Cars["2018 ferrari california"].Price)}\n
             ${cars.Cars["2005 pagani zonda f"].Emote} ${cars.Cars["2005 pagani zonda f"].Name} : $${numberWithCommas(cars.Cars["2005 pagani zonda f"].Price)}\n
             ...
             **${cars.Cars["2006 lamborghini gallardo"].Emote} ${cars.Cars["2006 lamborghini gallardo"].Name} : $${numberWithCommas(cars.Cars["2006 lamborghini gallardo"].Price)}** *TRIMS AVAILABLE*\n
...
.setColor("#60b0f4")   .setThumbnail("https://i.ibb.co/T0Cd62J/aclass.png")
  ...
  ${cars.Cars["2014 porsche 918 spyder"].Emote} ${cars.Cars["2014 porsche 918 spyder"].Name} : $${numberWithCommas(cars.Cars["2014 porsche 918 spyder"].Price)}\n
  ${cars.Cars["2012 pagani huayra"].Emote} ${cars.Cars["2012 pagani huayra"].Name} : $${numberWithCommas(cars.Cars["2012 pagani huayra"].Price)}\n
  ...
  ${cars.Cars["2017 mercedes amg one"].Emote} ${cars.Cars["2017 mercedes amg one"].Name} : $${numberWithCommas(cars.Cars["2017 mercedes amg one"].Price)}\n
   ...
   **`)
.setColor("#60b0f4")   .setThumbnail("https://i.ibb.co/Z13KtH8/sclass.png")
   interaction.editReply({embeds: [embed2], components: [row]})
   ...
   .setDescription(`**
   Page 1\n
   ${cars.Cars["2013 lamborghini veneno"].Emote} ${cars.Cars["2013 lamborghini veneno"].Name} : $${numberWithCommas(cars.Cars["2013 lamborghini veneno"].Price)}\n
   ${cars.Cars["2021 bugatti bolide"].Emote} ${cars.Cars["2021 bugatti bolide"].Name} : $${numberWithCommas(cars.Cars["2021 bugatti bolide"].Price)}\n
   ${cars.Cars["2020 koenigsegg regera"].Emote} ${cars.Cars["2020 koenigsegg regera"].Name} : $${numberWithCommas(cars.Cars["2020 koenigsegg regera"].Price)}\n
   ${cars.Cars["2021 koenigsegg gemera"].Emote} ${cars.Cars["2021 koenigsegg gemera"].Name} : $${numberWithCommas(cars.Cars["2021 koenigsegg gemera"].Price)}\n
   ${cars.Cars["2020 bugatti divo"].Emote} ${cars.Cars["2020 bugatti divo"].Name} : $${numberWithCommas(cars.Cars["2020 bugatti divo"].Price)}\n
   ...
   ${cars.Cars["2020 ssc tuatara"].Emote} ${cars.Cars["2020 ssc tuatara"].Name} : $${numberWithCommas(cars.Cars["2020 ssc tuatara"].Price)}\n
   ${cars.Cars["thrust ssc"].Emote} ${cars.Cars["thrust ssc"].Name} : $${numberWithCommas(cars.Cars["thrust ssc"].Price)}

  **
   `)
.setColor("#60b0f4")   .setThumbnail("https://i.ibb.co/9r2LJFT/UCLASS.png")
   interaction.editReply({embeds: [embed2], components: [row]})
   ...
   .setDescription(`**
   Page 1\n
   ${cars.Cars["2022 ford mustang mach e"].Emote} ${cars.Cars["2022 ford mustang mach e"].Name} : $${numberWithCommas(cars.Cars["2022 ford mustang mach e"].Price)}\n
   ${cars.Cars["2020 tesla model s"].Emote} ${cars.Cars["2020 tesla model s"].Name} : $${numberWithCommas(cars.Cars["2020 tesla model s"].Price)}\n
   ${cars.Cars["2022 audi e tron gt"].Emote} ${cars.Cars["2022 audi e tron gt"].Name} : $${numberWithCommas(cars.Cars["2022 audi e tron gt"].Price)}\n
   ${cars.Cars["2022 porsche taycan"].Emote} ${cars.Cars["2022 porsche taycan"].Name} : $${numberWithCommas(cars.Cars["2022 porsche taycan"].Price)}\n
   ${cars.Cars["2021 tesla model s plaid"].Emote} ${cars.Cars["2021 tesla model s plaid"].Name} : $${numberWithCommas(cars.Cars["2021 tesla model s plaid"].Price)}\n
   ${cars.Cars["2020 lotus evija"].Emote} ${cars.Cars["2020 lotus evija"].Name} : $${numberWithCommas(cars.Cars["2020 lotus evija"].Price)}\n
   ${cars.Cars["2022 rimac nevera"].Emote} ${cars.Cars["2022 rimac nevera"].Name} : $${numberWithCommas(cars.Cars["2022 rimac nevera"].Price)}
  **
   `)
.setColor("#60b0f4")   .setThumbnail("https://i.ibb.co/Qv4Grxk/EVCLASS.png")
   interaction.editReply({embeds: [embed2], components: [row]})
   ...
   **${cars.Cars["2021 lamborghini huracan sto"].Emote} ${cars.Cars["2021 lamborghini huracan sto"].Name} : ${(cars.Cars["2021 lamborghini huracan sto"].Obtained)}\n
   ...
   `)
.setColor("#60b0f4")   .setThumbnail("https://i.ibb.co/BTj07zB/newlogo2.png")
   interaction.editReply({embeds: [embed2], components: [row]})
...
.setThumbnail("https://i.ibb.co/jkR1Hp5/exotickey.png")
  ...
  **
   `)
.setColor("#60b0f4")   .setThumbnail("https://i.ibb.co/zJ7wvjv/policeclass.png")
   interaction.editReply({embeds: [embed2], components: [row]})
