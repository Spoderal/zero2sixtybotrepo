  ...
  data: new SlashCommandBuilder()
    ...
    async execute(interaction) {
        ...
        const db = require("quick.db");
            ...
            let cooldowndata2 = await Cooldowns.findOne({id: user2.id}) || new Cooldowns({id: user2.id})
           ...
           let timeout = 45000
            ...
            if(!cars.Cars[user1carchoice.Name.toLowerCase()]) return interaction.reply("Thats not a car!")
          ...
          userdata2.update()
           ...
           .setTitle("3...2...1....GO!")
           .addField(`${user.username}'s ${selected.Emote} ${selected.Name}`, `Speed: ${user1carspeed}\n\n0-60: ${newzero1}s`)
           .addField(`${user2.username}'s ${selected2.Emote} ${selected2.Name}`, `Speed: ${user2carspeed}\n\n0-60: ${newzero2}s`)
           .setColor("#60b0f4")
             ...
             if(timer >= 10){
               ...
               if(tracklength > tracklength2){
                   ...
                   if(racerank >= newrankrequired){
                    ...
                    userdata.racerank += 1
                           msg2.reply(`${user}, you just ranked up your race skill to ${userdata.racerank}!`)
                  ...
                  if(racerank >= newrankrequired){
                    ...
                    userdata2.racerank += 1
                          msg2.reply(`${user}, you just ranked up your race skill to ${userdata2.racerank}!`)
