...
const weather = require("../data/weather.json");
  ...
  module.exports = {
    ...
    async execute(interaction) {
      ...
      .setDescription("**Select a race from the menu below**\n\nDifferent races have different difficulties, and rewards")
      .setColor(colors.blue)
      .setThumbnail(`${selected.Livery}`)
      .addFields(
        {name: "Your car", value: `${selected.Emote} ${selected.Name}`}
      )

      let msg = await interaction.reply({embeds: [embed], components: [row2, row5], fetchReply: true})
      ...
      let race
      let races = ["streetrace", "highwayrace", "halfmile", "quartermile", "crossrace"]
      collector.on("collect", async (i) => {
        ...
        if(races.includes(i.customId)){
          ...
          if(i.customId == "streetrace" || i.customId == "highwayrace" || i.customId == "halfmile" || i.customId == "quartermile" || i.customId == "crossrace"){
          ...
          console.log(race)
            ...
            await i.update({embeds: [embed], components: [tierrow, tierrow2], fetchReply: true})

         
        }
         else  if(i.customId == 1 || i.customId == 2 || i.customId == 3 || i.customId == 4 || i.customId == 5 || i.customId == 6 || i.customId == 7){
         
          if(race[0].name == "streetrace"){
           let tracklength = 0;
      let tracklength2 = 0;
          await i.update({content: "Please wait...", components: [], fetchReply: true})
            console.log("street")
              console.log("race")
              ...
              if (bot == 1) {
                console.log("1")
                car2 = carsarray.filter((car) => car.Class == "D" && car.Speed < 140)
              } else if (bot == 2) {
                car2 = carsarray.filter((car) => car.Class == "C" && car.Speed < 160)
              } else if (bot == 3) {
                car2 = carsarray.filter((car) => car.Class == "B" && car.Speed < 180)
              } else if (bot == 4) {
                car2 = carsarray.filter((car) => car.Class == "A" && car.Speed < 200)
              } else if (bot == 5) {
                car2 = carsarray.filter((car) => car.Class == "S" && car.Speed < 210)
              } else if (bot == 6) {
                car2 = carsarray.filter((car) => car.Class == "S" && car.Speed < 220)
              } else if (bot == 7) {
                car2 = carsarray.filter((car) => car.Class == "S" && car.Speed < 250)
              }
                 ...
                 await i.editReply({
                  ...
                  let i2 = setInterval(async () => {
                    ...
                    // lost
                      ...
                      embed.setImage(`attachment://profile-image.png`);
                      userdata.cash += cashlost;
                      embed.setTitle(`Tier ${bot} Highway Race lost! ${weather2.Emote}`);
                      embed.setDescription(
                        `${emotes.cash} +${toCurrency(
                          cashlost
                        )}`
                 ...
                 await i.editReply({
                  ...
                  let i2 = setInterval(async () => {
                    ...
                    if (tracklength <= 0) {
                      ...
                      embed.setTitle(`Tier ${bot} Half Mile Race won! ${weather2.Emote}`);
                      embed.setImage(`attachment://profile-image.png`);
                    ...
                    // lost
                      ...
                      embed.setImage(`attachment://profile-image.png`);
                      userdata.cash += cashlost;
                      embed.setTitle(`Tier ${bot} Half Mile Race lost! ${weather2.Emote}`);
                      embed.setDescription(
                        `${emotes.cash} +${toCurrency(
                          cashlost
                        )}`
                 ...
                 await i.editReply({
                  ...
                  let i2 = setInterval(async () => {
                    ...
                    if (tracklength <= 0) {
                      ...
                      embed.setTitle(`Tier ${bot} Quarter Mile Race won! ${weather2.Emote}`);
                      embed.setImage(`attachment://profile-image.png`);
                    ...
                    // lost
                      ...
                      embed.setImage(`attachment://profile-image.png`);
                      userdata.cash += cashlost;
                      embed.setTitle(`Tier ${bot} Quarter Mile Race lost! ${weather2.Emote}`);
                      embed.setDescription(
                        `${emotes.cash} +${toCurrency(
                          cashlost
                        )}`
                     ...
                     await i.editReply({
                      ...
                      let i2 = setInterval(async () => {
                        ...
                        if (tracklength <= 0) {
                          ...
                          embed.setTitle(`Tier ${bot} Cross Country Race won! ${weather2.Emote}`);
                          embed.setImage(`attachment://profile-image.png`);
                        ...
                        // lost
                          ...
                          embed.setImage(`attachment://profile-image.png`);
                          userdata.cash += cashlost;
                          embed.setTitle(`Tier ${bot} Cross Country Race lost! ${weather2.Emote}`);
                          embed.setDescription(
                            `${emotes.cash} +${toCurrency(
                              cashlost
                            )}`
