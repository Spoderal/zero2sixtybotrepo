...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("squad")
    .setDescription("Show the information of the squad you're at, or another squad")
  ...
  async execute(interaction) {
    ...
    if(option == "list"){
      ...
      for(let s in squadsarr){
        embed.addFields({name: `${squadsarr[s].Emote} ${squadsarr[s].Name}`, value: `Tier: ${squadsarr[s].Tier}`, inline: true})
      ...
      let squadfiltered = squadsarr.filter((squad) => squad.Name.toLowerCase() == squatofind);
