    ...
    if (!userdata?.id) return await interaction.reply(GET_STARTED_MESSAGE);
      ...
      for(let field in rewards[pageofuser]){
        ...
        if(data.Item.endsWith("Cash")){
          ...
          embed.addFields(
            {name: `Reward ${data.Number}`, value: `${toCurrency(amount[0])}\n${numberWithCommas(data.Required)} ${emotes.notoriety}`, inline: true}
          )
          ...
          let amount = data.Item.split(" ")
          embed.addFields(
            {name: `Reward ${data.Number}`, value: `${numberWithCommas(amount[0])} ${emotes.rareKey}\n${numberWithCommas(data.Required)} ${emotes.notoriety}`, inline: true}
          )
          ...
          let amount = data.Item.split(" ")
          embed.addFields(
            {name: `Reward ${data.Number}`, value: `${numberWithCommas(amount[0])} ${emotes.commonKey}\n${numberWithCommas(data.Required)} ${emotes.notoriety}`, inline: true}
          )
          ...
          let amount = data.Item.split(" ")
          embed.addFields(
            {name: `Reward ${data.Number}`, value: `${numberWithCommas(amount[0])} ${emotes.exoticKey}\n${numberWithCommas(data.Required)} ${emotes.notoriety}`, inline: true}
          )
          ...
          let amount = data.Item.split(" ")
          embed.addFields(
            {name: `Reward ${data.Number}`, value: `${numberWithCommas(amount[0])} ${emotes.addgarage} Garage Space\n${numberWithCommas(data.Required)} ${emotes.notoriety}`, inline: true}
          )
          ...
          let amount = data.Item.split(" ")
          embed.addFields(
            {name: `Reward ${data.Number}`, value: `${numberWithCommas(amount[0])} ${emotes.rp}\n${numberWithCommas(data.Required)} ${emotes.notoriety}`, inline: true}
          )
          ...
          embed.addFields(
            {name: `Reward ${data.Number}`, value: `${car.Emote} ${car.Name}\n${numberWithCommas(data.Required)} ${emotes.notoriety}`, inline: true}
          )
          ...
          embed.addFields(
            {name: `Reward ${data.Number}`, value: `${car.Title} Title\n${numberWithCommas(data.Required)} ${emotes.notoriety}`, inline: true}
          )
      ...
      let msg = await interaction.reply({embeds: [embed], components: [row9, rowclaim], fetchReply: true})
      ...
      collector.on("collect", async (i) => {
       ...
       rewardtoclaim = seasonRewards[`${claimable}`]
        ...
        await i.update({embeds: [embed], fetchReply: true, components: [row9, rowclaim]})
