const {
  ...
  module.exports = {
    ...
    async execute(interaction) {
      ...
      interaction.reply({ embeds: [embed], components: [row2], fetchReply: true })
        .then((msg) => {
          ...
          collector.on("collect", async (collected) => {
            ...
            if (value === "1_update") {
              ...
              await interaction.editReply({ embeds: [embed], components: [row2] });
                ...
                embed.setDescription(`• Support server cash multiplier for botraces and daily cash\n
              ...
              embed.setDescription(`• Garage update, filtering added, and the garage now uses buttons.\n
