  ...
  async execute(guild) {
    ...
    try {
      ...
      let embed = new EmbedBuilder()
        ...
        .setDescription(
          "Thank you for inviting the bot! There are a ton of features, so it may seem overwhelming at first, but you can run `/start` and the tutorial will go over the basics, also if its your first time running a command it'll explain the command in detail!\n\nYou can always join the support server [here](https://discord.gg/5j8SYkrf4z) as well"
        );
