          ...
          if (
            ...
            try {
              ...
              if(udata){
                  ...
                  if (udata.perfectengineering == true && bountycool !== null && timeout - (Date.now() - bountycool) < 0) {
                    let cartopull = udata.cars.filter((car) => car.Name == "1980 Porsche 911")
                    ...
                    if(cartopull[0] && udata.perfectengineeringcomplete == false){
                      ...
                      for(let p in udata.parts){
                          ...
                          if(partdb.Parts[part].Loan && partdb.Parts[part].Loan == true) {
